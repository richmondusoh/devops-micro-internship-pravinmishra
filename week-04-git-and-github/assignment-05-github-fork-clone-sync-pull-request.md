...
![alt text](assignment05_task0_screenshot2.jpg).
...
![alt text](assignment05_task0_screenshot3.jpg).
...
![alt text](assignment05_task3_screenshot3new.jpg).
...
![alt text](assignment05_task3_screenshot4.jpg).

---

#### Screenshot 5 — Output of `git commit`

![alt text](assignment05_task3_screenshot5.jpg).
...
![alt text](assignment05_task3_screenshot6new.jpg).

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

https://github.com/richmondusoh/devops-micro-internship-interviews/tree/feature-readme-update.
...
![alt text](assignment05_task5_screenshot8.jpg).

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![alt text](assignment05_task5_screenshot9.jpg).
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/441`
